...
export const MOCK_PERSONAS: Persona[] = [
  {
    ...
    status: "online",
    bio: "Plans system design before code gets written. Reviews architectural decisions and flags risk early, before a developer agent starts implementing.",
  ...
  },
  {
    ...
    model: "DeepSeek V3.2",
    status: "busy",
    bio: "Implements features inside isolated worktrees. Writes tests alongside code, not after, and opens a diff for review before anything merges.",
  ...
  },
  {
    ...
    status: "online",
    bio: "Reviews diffs for vulnerabilities before merge and runs the test suite to block regressions. Has no shell-write access by design.",
  ...
  },
  {
    ...
    model: "Gemini 3 Pro",
    status: "paused",
    bio: "Owns CI, deploys, and infrastructure changes. Paused until the OAuth work is ready to ship — no need to burn budget standing by.",
